...
{
	public static InvoiceDto AddDataToInvoiceDto(ExcelRange invoiceData, int currentRow)
	{
		var invoiceDto = new InvoiceDto
		{
			...
			SupplierName = invoiceData[currentRow, 7].Value.ToString() ?? string.Empty,
			SupplierTIN = invoiceData[currentRow, 8].Value.ToString() ?? string.Empty,
			SupplierIDType = invoiceData[currentRow, 9].Value.ToString() ?? string.Empty,
			SupplierIDNo = invoiceData[currentRow, 10].Value.ToString() ?? string.Empty,
			SupplierAddressAddressLine0 = invoiceData[currentRow, 11].Value.ToString() ?? string.Empty,
			SupplierAddressCityName = invoiceData[currentRow, 12].Value.ToString() ?? string.Empty,
			SupplierAddressState = invoiceData[currentRow, 13].Value.ToString() ?? string.Empty,
			SupplierAddressCountryCode = invoiceData[currentRow, 14].Value.ToString() ?? string.Empty,
			SupplierSSTNo = invoiceData[currentRow, 15].Value.ToString() ?? string.Empty,
			SupplierMSICCode = invoiceData[currentRow, 16].Value.ToString() ?? string.Empty,
			SupplierBusinessActivityDescription = invoiceData[currentRow, 17].Value.ToString() ?? string.Empty,
			SupplierContactNumber = invoiceData[currentRow, 18].Value.ToString() ?? string.Empty,
			TotalExcludingTax = invoiceData[currentRow, 19].Value.ToString() ?? string.Empty,
			TotalIncludingTax = invoiceData[currentRow, 20].Value.ToString() ?? string.Empty,
			TotalPayableAmount = invoiceData[currentRow, 21].Value.ToString() ?? string.Empty,
			TotalTaxAmount = invoiceData[currentRow, 22].Value.ToString() ?? string.Empty
		};
